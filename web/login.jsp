            ...
            <div class="nav">
              <div class="nav_search">
                <form action="MainController" class="search-bar">
                  ...
                  <button type="submit" value="Search" name="action"><i class="fa fa-search"></i></button>
                </form>
              </div>
              <div class="nav_btn">
                <ul
                    ...
                    <div class="item shadow overflow-hidden mb-4">
                      <a href="#" target="_blank">
                        ...
                        <div class="info p-3 text-center">
                          ...
                          <p><%=event.getStartTime().toString()%></p>
                          <p><%=event.getEndTime().toString()%></p>

                          <p><%=event.getLocationName()%></p>
